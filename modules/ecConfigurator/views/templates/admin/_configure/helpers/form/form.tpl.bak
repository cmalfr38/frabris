...
{block name="input_row"}
  {if $input.type == 'checkbox_table'}
    ...
    {if isset($options) && count($options) > 0}
      <div class="form-group {$input.class_block|escape:'html'}" {if isset($input.tab)}data-tab-id="{$input.tab|escape:'htmlall':'UTF-8'}"{/if} >
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <th style="float: right;">
                    <a href="#" id="check_all" class="btn btn-default"><i class="icon-check-sign"></i> {l s='Check all'  mod='related_options'}</a>
                    &nbsp;
                    <a href="#" id="uncheck_all" class="btn btn-default"><i class="icon-check-empty"></i> {l s='Uncheck All'  mod='related_options'}</a>
                  </th>
                  {if $input.search}
                  <th>
                    <span class="title_box">
                        <input type="text" class="search_checkbox_table" placeholder="{l s='search...'  mod='related_options'}">
                    </span>
                  </th>
                  {/if}
                </tr>
